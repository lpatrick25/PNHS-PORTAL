...
class UpdateStudentRequest extends FormRequest
{
    ...
    {
        return [
            'student_lrn' => ['required', 'string', 'min:12', 'max:12', Rule::unique('students', 'student_lrn')->ignore($this->student_lrn, 'student_lrn')],
            'rfid_no' => ['required', 'string', Rule::unique('students', 'rfid_no')->ignore($this->student_lrn, 'student_lrn')],
            ...
            'email' => ['required', 'email', 'max:50', Rule::unique('students', 'email')->ignore($this->student_lrn, 'student_lrn')],
