...
class Teacher extends Model implements HasMedia
{
    ...
    {
        return $this->hasMany(Adviser::class, 'teacher_id');
    }

    public function subjectLoads()
    {
        return $this->hasMany(TeacherSubjectLoad::class, 'teacher_id');
    }

    public function subjects()
    {
        return $this->belongsToMany(Subject::class, 'teacher_subject_loads', 'teacher_id', 'subject_id')
            ->withPivot('school_year_id', 'grade_level', 'section');
    }
