<aside class="main-sidebar elevation-4 sidebar-dark-indigo sidebar-no-expand text-lg">
    ...
    <div class="sidebar">
        <div class="user-panel d-flex align-items-center p-3">
            ...
            <div class="info ms-3">
                <a href="#" class="d-block fw-bold" style="font-size: 1rem;">{{ auth()->user()->principal->full_name_with_extension }}</a>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-collapse-hide-child nav-child-indent"
                ...
                <li class="nav-item">
                    <a href="{{ route('principal.students') }}" class="nav-link @yield('active-student-list')">
                        <i class="nav-icon ion ion-university"></i>
                        <p>Students</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('principal.teachers') }}" class="nav-link @yield('active-teacher-list')">
                        <i class="nav-icon ion ion-university"></i>
                        <p>Teachers</p>
                    </a>
                </li>
